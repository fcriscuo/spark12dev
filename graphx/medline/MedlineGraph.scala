...
package org.mskcc.cbio.spark12dev.graphx.medline
...
object MedlineGraph extends Serializable {

  def main(args: Array[String]): Unit = {
    val sc = new SparkContext(new SparkConf().setAppName("Graph").setMaster("local"))

    val medlineRaw = loadMedline(sc, "file:///data/medline_data/medline")
